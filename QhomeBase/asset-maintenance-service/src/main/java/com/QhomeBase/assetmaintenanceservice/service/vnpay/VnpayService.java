package com.QhomeBase.assetmaintenanceservice.service.vnpay;
...
public class VnpayService {
    ...
    public String createPaymentUrl(Long orderId, String orderInfo, BigDecimal amountVnd, String clientIp, String returnUrl) {
        try {
            ...
            log.info("💳 [VNPAY] Generated payment URL: orderId={}, amount={}, ip={}, txnRef={}", orderId, amountVnd, clientIp, txnRef);
            return paymentUrl;
        } catch (Exception e) {
            log.error("❌ [VNPAY] Failed to generate payment URL", e);
